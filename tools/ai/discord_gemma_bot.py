...
QUICK_REPLIES = {
    ...
    "ただいま": "おかえりなさい😊",
    "いってきます": "お気をつけて😊",
    "眠い": "寝ましょう😇 無理しないのが一番です。",
    "ねむい": "寝ましょう😇 無理しないのが一番です。",
    "腹減った": "ちゃんとご飯食べてくださいね🍚",
    "飲む": "🍺😇 ほどほどにですよ？",
    "酔えお": "🍺😇 かんぱーい♪",
    "乾杯": "🍺😇 かんぱーい♪",
...
from tools.location.placeinfo_test_buttons import create_placeinfo_test_view, handle_placeinfo_coordinate_message  # noqa: E402
...
def main() -> int:
    ...
    class GemmaDiscordClient(discord.Client):
        async def setup_hook(self) -> None:
            ...
            self.add_view(create_placeinfo_test_view(discord))
    ...
    async def on_message(message: Any) -> None:
        try:
            ...
            if not content and not attachments:
                return
            if content and await handle_placeinfo_coordinate_message(message):
