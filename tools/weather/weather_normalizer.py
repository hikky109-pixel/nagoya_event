...
try:
    ...
    from get_open_meteo_alerts import get_open_meteo_snapshot
    ...
    from tools.weather.get_open_meteo_alerts import get_open_meteo_snapshot
...
def get_all_weather_snapshot(now: datetime | None = None) -> dict:
    ...
    # Lv17.8でも旧Open-Meteo 1時間通知はnormalized_alertsへ合流させない。
    ...
    return {
        "source": ["JMA", "YahooWeather", "Open-Meteo"],
        "raw_jma": jma.get("raw", {}),
        "raw_yahoo": yahoo,
