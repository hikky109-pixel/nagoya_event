...
Cloudflare Tunnel運用手順は [docs/gps_cloudflare_tunnel.md](docs/gps_cloudflare_tunnel.md) を参照。
...
python3 tools/location/gps_web_app.py --host 0.0.0.0 --port 8787
curl http://localhost:8787/gps
```
